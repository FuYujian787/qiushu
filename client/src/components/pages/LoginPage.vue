  ...
  <div class="login-wrapper">
    <div class="login-card apple-auth-card">
      <div class="logo-section">
        ...
        <h1 class="login-brand-title apple-text-gradient font-serif-display">紫金求思</h1>
        <p>你的校园智慧购书管家</p>
      </div>
      <div class="form-section">
        <h2 class="apple-auth-title font-serif-display">账号登录</h2>
        ...
        <button class="login-btn apple-liquid-btn apple-liquid-btn-primary" @click="doLogin" :disabled="loggingIn" :class="{ 'apple-liquid-btn-loading': loggingIn }" type="button">{{ loggingIn ? '登录中...' : '登录' }}</button>
